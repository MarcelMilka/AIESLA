...
// AndroidRecoverYourPasswordScreenTest used to test ime behavior
// ComposeRecoverYourPasswordScreenTest used to test rest of the behavior

@HiltAndroidTest
class AndroidRecoverYourPasswordScreenTest {
    ...
    private val emailTextField = acr.onNodeWithTag("RecoverYourPasswordScreen emailTextField")
    ...
    fun before() {
        ...
        // navigate from 'SignUpScreen' to 'RecoverYourPasswordScreen'
    ...
    fun `emailTextField is focused automatically after entering the screen`() = runTest {
        ...
        acr.activityRule.scenario.onActivity {
            it.window.decorView.rootWindowInsets.isVisible(WindowInsets.Type.ime())
        }
