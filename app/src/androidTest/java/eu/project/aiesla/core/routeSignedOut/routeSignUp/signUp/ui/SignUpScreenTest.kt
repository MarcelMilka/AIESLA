package eu.project.aiesla.core.routeSignedOut.routeSignUp.signUp.ui
...
// AndroidSignUpScreenTest used to test ime behavior
// ComposeSignUpScreenTest used to test rest of the behavior

@HiltAndroidTest
class AndroidSignUpScreenTest {
...
class ComposeSignUpScreenTest {
    ...
    fun `email text field - displays Timeout`() = runTest {
        ...
        emailTextFieldHintImpl.assertIsDisplayed()
        emailTextFieldHint.assertIsDisplayed()
        ctr.onNodeWithText(getResourceString(R.string.timeout)).assertIsDisplayed()
    }
